...
def label_encode_dataframe(config, df):
    ...
    for col in categorical_cols:
        ...
        encoder_mapping = dict(zip(label_encoder.classes_.tolist(),
...
def process_dataframe(df):
    ...
    df_new = (pd.concat([df_new, df_new['Blood Pressure'].str.split('/', expand=True)], axis=1)
    ...
    df_new[['Blood Pressure High', 'Blood Pressure Low']] = (df_new[['Blood Pressure High', 'Blood Pressure Low']]
                                                             .apply(pd.to_numeric))
