# -*- coding: utf-8 -*-
#
# mlops_sleephealth_main documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'mlops_sleephealth_main'
...
htmlhelp_basename = 'mlops_sleephealth_maindoc'
...
latex_documents = [
    ('index',
     'mlops_sleephealth_main.tex',
     u'mlops_sleephealth_main Documentation',
     u"raji", 'manual'),
]
